...
25/07/18: 原 10 trial/class -> 動作 -> 10 trial/class -> 動作 -> 10 trial/class
          改為依照論文內容  20 trial/class -> 動作 -> 20 trial/class
          單次做  20 trial/class  30 trial 休息
"""
import matplotlib
...
def SSVEP(perform_time, FREQ=6, marker=999):
    ...
    if FREQ == 0:
        ...
        # UI Settings
        screen = pygame.display.set_mode((600, 600), display=0)
